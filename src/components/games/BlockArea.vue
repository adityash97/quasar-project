  ...
  <div >
    <div v-if="showBlockArea" class="row">
      <div class="col-4 offset-4">
        <q-card style="height: 250px; width: 250px; background:green" class="text-center" @click="stopTimer">
            <q-card-section>
    ...
    <div v-if="showResult" class="row">
      <div class="col offset-4">
        <div class="text-h4">
          You Took : {{reactionTime}} sec.
        </div>

        <div v-if="reactionTime > 3 " class="text-h4">Are you a snail? Next time hit it fast</div>
        <div v-if="reactionTime < 2 && reactionTime > 1" class="text-h4">Hmm.. Kind of good shot</div>
